...
<div class="flex flex-wrap">
    <header class="flex w-full items-center justify-between p-4 dark:bg-zinc-700">
		<span class="dark:text-gray-50">{{ $tipo }}</span>
		<button class="flex items-center space-x-2 rounded p-2 dark:bg-zinc-500" type="button">
